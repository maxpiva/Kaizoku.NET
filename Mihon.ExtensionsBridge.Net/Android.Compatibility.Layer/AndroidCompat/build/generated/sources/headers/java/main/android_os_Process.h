...
extern "C" {
#endif
#undef android_os_Process_ROOT_UID
#define android_os_Process_ROOT_UID 0L
...
#undef android_os_Process_KEYSTORE_UID
#define android_os_Process_KEYSTORE_UID 1017L
...
#undef android_os_Process_SHARED_RELRO_UID
#define android_os_Process_SHARED_RELRO_UID 1037L
#undef android_os_Process_AUDIOSERVER_UID
#define android_os_Process_AUDIOSERVER_UID 1041L
#undef android_os_Process_CAMERASERVER_UID
#define android_os_Process_CAMERASERVER_UID 1047L
#undef android_os_Process_WEBVIEW_ZYGOTE_UID
#define android_os_Process_WEBVIEW_ZYGOTE_UID 1051L
#undef android_os_Process_OTA_UPDATE_UID
#define android_os_Process_OTA_UPDATE_UID 1061L
#undef android_os_Process_NOBODY_UID
#define android_os_Process_NOBODY_UID 9999L
...
#undef android_os_Process_SHARED_USER_GID
#define android_os_Process_SHARED_USER_GID 9997L
...
#undef android_os_Process_FIRST_APPLICATION_CACHE_GID
#define android_os_Process_FIRST_APPLICATION_CACHE_GID 20000L
#undef android_os_Process_LAST_APPLICATION_CACHE_GID
#define android_os_Process_LAST_APPLICATION_CACHE_GID 29999L
...
#undef android_os_Process_SCHED_RESET_ON_FORK
#define android_os_Process_SCHED_RESET_ON_FORK 1073741824L
...
#undef android_os_Process_THREAD_GROUP_TOP_APP
#define android_os_Process_THREAD_GROUP_TOP_APP 5L
#undef android_os_Process_THREAD_GROUP_RT_APP
#define android_os_Process_THREAD_GROUP_RT_APP 6L
...
#undef android_os_Process_PROC_CHAR
#define android_os_Process_PROC_CHAR 2048L
...
/*
 * Class:     android_os_Process
 * Method:    setThreadGroupAndCpuset
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_android_os_Process_setThreadGroupAndCpuset
  (JNIEnv *, jclass, jint, jint);
 ...
 * Signature: ()[I
 */
JNIEXPORT jintArray JNICALL Java_android_os_Process_getExclusiveCores
  (JNIEnv *, jclass);
...
/*
 * Class:     android_os_Process
 * Method:    getThreadScheduler
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_android_os_Process_getThreadScheduler
  (JNIEnv *, jclass, jint);
 ...
 * Signature: (II)I
 */
JNIEXPORT jint JNICALL Java_android_os_Process_killProcessGroup
  (JNIEnv *, jclass, jint, jint);

/*
 * Class:     android_os_Process
 * Method:    removeAllProcessGroups
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_android_os_Process_removeAllProcessGroups
  (JNIEnv *, jclass);
