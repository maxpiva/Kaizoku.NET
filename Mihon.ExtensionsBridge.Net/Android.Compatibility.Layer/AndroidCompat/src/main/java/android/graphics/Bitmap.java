...
public final class Bitmap {
    ...
    public int getPixel(int x, int y) {
        ...
        if (x >= width || y >= height) {
            throw new IllegalArgumentException("x,y must be within the bitmap bounds");
        }
    ...
    public void copyPixelsFromBuffer(Buffer src) {
        ...
        if (src instanceof IntBuffer) {
            IntBuffer buffer = (IntBuffer) src;
            if (buffer.remaining() < pixelCount) {
                throw new RuntimeException("Buffer not large enough for bitmap pixels");
            }
        ...
        if (src instanceof ByteBuffer) {
            ByteBuffer buffer = (ByteBuffer) src;
        ...
        throw new IllegalArgumentException("Unsupported Buffer type: " + src.getClass());
    }
    public void recycle() {
        // do nothing
    }
