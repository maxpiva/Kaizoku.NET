...
public class CustomContext extends Context {
    ...
    private final AndroidCompatLogger logger = AndroidCompatLogger.forClass(CustomContext.class);
    ...
    public ComponentName startServiceAsUser(Intent service, UserHandle user) {
        logger.warn(() ->
            "An attempt was made to start the service '" +
                service.getComponent().getClassName() +
                "' as another user. This is not supported; falling back to the current user.");
    ...
    public boolean stopServiceAsUser(Intent service, UserHandle user) {
        logger.warn(() ->
            "An attempt was made to stop the service '" +
                service.getComponent().getClassName() +
                "' as another user. This is not supported; falling back to the current user.");
