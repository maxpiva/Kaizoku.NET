...
public class TemplateParser : ITemplateParser
{
    ...
    /// <inheritdoc/>
    public string ParseFileName(string template, TemplateVariables vars, SettingsDto settings)
    {
    ...
    /// <inheritdoc/>
    public string ParseFolderPath(string template, TemplateVariables vars, SettingsDto settings)
    {
    ...
    {
        var sampleSettings = new SettingsDto
        {
    ...
    private string ExpandTemplate(string template, TemplateVariables vars, SettingsDto settings, bool isFileName)
    {
    ...
    private string GetVariableValue(string varName, string? format, TemplateVariables vars, SettingsDto settings, bool isFileName)
    {
    ...
    private static string FormatChapter(decimal? chapter, string? format, decimal? maxChapter, SettingsDto settings)
    {
        if (!chapter.HasValue)
            return "";
    ...
    private static string FormatVolume(int? volume, string? format, SettingsDto settings)
    {
        if (!volume.HasValue)
            return "";
