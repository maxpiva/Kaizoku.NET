        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Import>(entity =>
            {
                ...
                entity.Property(i => i.Action)
                    .IsRequired()
                    .HasDefaultValue(KaizokuBackend.Models.Action.Add)
                    .HasConversion<int>();
                // Configure JSON conversion for ImportSeriesSnapshot
                entity.Property(i => i.Info)
                    .HasConversion(
                        v => JsonSerializer.Serialize(v, new JsonSerializerOptions { WriteIndented = false }),
                        v => JsonSerializer.Deserialize<KaizokuBackend.Models.ImportSeriesSnapshot>(v, new JsonSerializerOptions { WriteIndented = false }) ?? new KaizokuBackend.Models.ImportSeriesSnapshot()
                    ).Metadata.SetValueComparer(GenericValueComparer.Create<KaizokuBackend.Models.ImportSeriesSnapshot>());
